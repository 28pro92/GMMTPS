...
fit.full.cohort = glm(rel ~ histol*stage + histol*age + stage*age, family = binomial(), data = cohort.study)
...
#sampling.fraction.controls.strata1 = 0.09
...
saveRDS(results.npmle.missreg, file="/Users/prosenjitkundu/Desktop/Code_biometrics_github/Real_data_analysis/missreg/missreg_realdata_balanced_w_age_new.rds")
