...
saveRDS(sim.results, file="/Users/prosenjitkundu/Desktop/Code_biometrics_github/Simulation/Table2_results/genmeta_realdata_simulation_balanced_w_main_effects_phase_I.rds")
