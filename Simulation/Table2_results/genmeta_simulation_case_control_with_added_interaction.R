...
rho_nwtco_matrix = cor(cbind(nwtco$instit, nwtco$histol, nwtco$stage,age/12))
...
saveRDS(sim.results, file="/Users/prosenjitkundu/Desktop/Code_biometrics_github/Simulation/Table2_results/genmeta_realdata_simulation_CC_w_additional_interaction.rds")
