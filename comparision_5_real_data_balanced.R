...
for(i in 1:1000)
{
  ...
  phase_II_var = c("X.Intercept.","instit2", "histol2","stage2","stage3","stage4","age","histol2.stage2", "histol2.stage3", "histol2.stage4")
...
saveRDS(sim.results, file="genmeta_realdata_simulation_balanced_w_age_saturated.rds")
